...
(
    ...
    `bot_intent`   varchar(255) NOT NULL COMMENT 'Intenção - nome da intenção',
    ...
    `bot_reply`    text         NOT NULL COMMENT 'Resposta ao user',
    PRIMARY KEY (`bot_id`),
    UNIQUE KEY `sm_bot_bot_intent_uindex` (`bot_intent`)
) ENGINE = MyISAM
  AUTO_INCREMENT = 25
...
VALUES (1, 'createCliente', 'cadastrar cliente',
       ...
       (2, 'cumprimento', 'bom turno',
        '{\r\n  \"exemples\": [\r\n    \"Bom dia!\",   \r\n    \"Boa tarde!\",   \r\n    \"Boa noite!\"\r\n  ]\r\n}',
        'function'),
       (24, 'respNegativa', 'resposta negativa',
       ...
       (3, 'fretePrecoPrazo', 'calcule frete',
